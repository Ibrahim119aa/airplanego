        ...
        <div data-aos="zoom-in" data-duration="1000" className="Parent-Layout bg-white">
            <div className="Parent-Child pt-6 pb-4">
                <div className="flex flex-col lg:grid lg:grid-cols-6 gap-8 lg:gap-0">
                    <div className="lg:col-span-1 flex flex-col gap-5 items-center lg:items-start">
                        <div>
                            <Image
                        ...
                        <div className="flex gap-2 justify-center lg:justify-start">
                            ...
                            <a href="" className="no-underline">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    preserveAspectRatio="xMidYMid meet"
                                    data-test="Footer-IconTwitter"
                                    aria-hidden="true"
                                >
                                    <path d="M17.521 3.312h2.944l-6.432 7.352L21.6 20.666h-5.925l-4.64-6.067-5.31 6.067H2.78l6.88-7.863L2.4 3.312h6.075l4.195 5.546 4.851-5.546Zm-1.033 15.593h1.631L7.59 4.982h-1.75l10.649 13.923Z"></path>
                                </svg>
                            </a>
                            <a href="" className="no-underline">
                                <svg
                    ...
                    <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 lg:mt-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <h4 className="primary-heading">Platform</h4>
                            <Link href={""} className="secondary-link">
                                Terms & Condition
                            </Link>
                            <Link href={""} className="secondary-link">
                        ...
                        <div className="flex flex-col gap-2">
                            <h4 className="primary-heading">Features</h4>
                            <Link href={""} className="secondary-link">
                                Terms & Condition
                            </Link>
                            <Link href={""} className="secondary-link">
                        ...
                        <div className="flex flex-col gap-2">
                            <h4 className="primary-heading">Discover</h4>
                            <Link href={""} className="secondary-link">
                                Terms & Condition
                            </Link>
                            <Link href={""} className="secondary-link">
